...
from script.postgress_manager import create_tables, insert_data
...
TRAJECTORY_SCHEMA = os.path.join(
    dag_path, "dags/script/trajectory_info_schema.sql")
VEHICLE_SCHEMA = os.path.join(dag_path, "dags/script/vehicle_info_schema.sql")
